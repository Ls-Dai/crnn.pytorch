...
if __name__ == '__main__':
    ...
    parser.add_argument('--trainRoot', required=False,
                        help='path to dataset', default="./data/train/")
    ...
    parser.add_argument('--imgW', type=int, default=640,
    ...
    parser.add_argument('--random_sample', action='store_true',
                        help='whether to sample the dataset with random sampler', default=True)
    ...
    train_dataset = dataset.OcrDataset(
        root_im=opt.trainRoot + "images/", label_path=opt.trainRoot + "labels.csv")
